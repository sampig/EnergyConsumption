...
//        rawResult = multiFormatReader.decodeWithState(bitmap);
                rawResult = multiFormatReader.decodeMultiple(bitmap, hints);
//                DetectorResult[] detectorResults = (new MultiDetector(bitmap.getBlackMatrix())).detectMulti(hints);
        ...
        if (rawResult != null && rawResult.length > 0) {
            ...
            if (handler != null) {
                ...
                bundle.putFloatArray(DecodeThread.BARCODE_POSITION, new float[]{});
